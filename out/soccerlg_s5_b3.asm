...
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:106: return TRUE;
	...
	jp	00125$
00108$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:111: if (TimerEnabled == FALSE && KickOffTeam == TEAM_2) {
	ld	a, (_TimerEnabled+0)
	or	a, a
	jr	NZ, 00110$
	ld	a, (_KickOffTeam+0)
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:112: return FALSE;
	dec	a
	jp	Z,00125$
00110$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:115: u8 reference_player = 0;
	ld	-13 (ix), #0x00
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:119: if (g_is_ball_carried && LastTouchPlayer != 0xFF && LastTouchPlayer < 14) {
	...
	inc	a
	jr	Z, 00116$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:120: reference_player = LastTouchPlayer;
	ld	a,(_LastTouchPlayer+0)
	cp	a,#0x0e
	jr	NC, 00116$
	ld	-13 (ix), a
	jp	00117$
00116$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:122: u16 min_dist = 0xFFFF;
	ld	-12 (ix), #0xff
	ld	-11 (ix), #0xff
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:123: for (u8 i = 0; i < 14; i++) {
	ld	a, (#_SwSprite + 322)
	ld	-10 (ix), a
	ld	-1 (ix), #0x00
00123$:
	...
	sub	a, #0x0e
	jp	NC, 00117$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:124: u16 dx = (SwSprite[i].lx > SwSprite[14].lx) ? (SwSprite[i].lx - SwSprite[14].lx) : (SwSprite[14].lx - SwSprite[i].lx);
	ld	c, -1 (ix)
	ld	b, #0x00
	ld	l, c
	ld	h, b
...
00127$:
	...
	ld	-2 (ix), a
00128$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:125: u16 dy = (SwSprite[i].ly > SwSprite[14].ly) ? (SwSprite[i].ly - SwSprite[14].ly) : (SwSprite[14].ly - SwSprite[i].ly);
	ld	c, -9 (ix)
	ld	b, -8 (ix)
	ld	hl, #4
	add	hl, bc
...
00130$:
	ld	c, -5 (ix)
	ld	b, -4 (ix)
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:126: u16 dist = dx + dy;
	ld	l, -3 (ix)
	ld	h, -2 (ix)
	add	hl, bc
	ld	-3 (ix), l
	ld	-2 (ix), h
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:128: if (dist < min_dist) {
	ld	a, -3 (ix)
	sub	a, -12 (ix)
	ld	a, -2 (ix)
	sbc	a, -11 (ix)
	jr	NC, 00124$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:129: min_dist = dist;
	ld	a, -3 (ix)
	ld	-12 (ix), a
	ld	a, -2 (ix)
	ld	-11 (ix), a
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:130: reference_player = i;
	ld	a, -1 (ix)
	ld	-13 (ix), a
00124$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:123: for (u8 i = 0; i < 14; i++) {
	...
	jp	00123$
00117$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:139: if (SwSprite[14].ly < SwSprite[reference_player].ly + 1) {
	ld	hl, #_SwSprite + 326
	ld	a, (hl)
	ld	-4 (ix), a
	inc	hl
...
;	spillPairReg hl
	...
	sbc	hl, bc
	jr	NC, 00121$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:140: return FALSE;
	xor	a, a
	jp	00125$
00121$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:143: return TRUE;
	ld	a, #0x01
00125$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:144: }
	ld	sp, ix
	pop	ix
	ret
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:147: void ShowSpriteMessage(u16 messageId)
;	---------------------------------
...
_ShowSpriteMessage::
	...
	ld	c, l
	ld	b, h
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:153: if (messageId == SPR_MSG_KICKOFF) {
	ld	a, c
	sub	a, #0x20
	jr	NZ, 00126$
	ld	a, b
	dec	a
	jr	NZ, 00126$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:154: len = SPRITE_MSG_KICKOFF_LENGTH;
	ld	-9 (ix), #0x04
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:155: logical_y = (KickOffTeam == TEAM_1) ? (Field.ly + 48) : (Field.ly + 144); // Centro della rispettiva metà inquadratura
	ld	a, (_KickOffTeam+0)
	or	a, a
	jr	NZ, 00138$
	ld	hl, (#(_Field + 4) + 0)
...
00139$:
	...
	jp	00127$
00126$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:156: } else if (messageId == SPR_MSG_GOALKICK) {
	ld	a, c
	sub	a, #0x24
	jr	NZ, 00123$
	ld	a, b
	dec	a
	jr	NZ, 00123$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:157: len = SPRITE_MSG_GOALKICK_LENGTH;
	ld	-9 (ix), #0x05
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:158: logical_y = Field.ly + 96; // Metà dello schermo (192 / 2)
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0060
	add	hl, de
	ex	de, hl
	jp	00127$
00123$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:159: } else if (messageId == SPR_MSG_THROWIN) {
	ld	a, c
	sub	a, #0x29
	jr	NZ, 00120$
	ld	a, b
	dec	a
	jr	NZ, 00120$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:160: len = SPRITE_MSG_THROWIN_LENGTH;
	ld	-9 (ix), #0x05
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:161: logical_y = Field.ly + 96;
	...
	jp	00127$
00120$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:162: } else if (messageId == SPR_MSG_CORNERKICK) {
	ld	a, c
	sub	a, #0x30
	jr	NZ, 00117$
	ld	a, b
	dec	a
	jr	NZ, 00117$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:163: len = SPRITE_MSG_CORNERKICK_LENGTH;
	ld	-9 (ix), #0x06
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:164: logical_y = Field.ly + 96;
	...
	jp	00127$
00117$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:165: } else if (messageId == SPR_MSG_INGOAL) {
	ld	a, c
	sub	a, #0x39
	jr	NZ, 00114$
	ld	a, b
	dec	a
	jr	NZ, 00114$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:166: len = SPRITE_MSG_INGOAL_LENGTH;
	ld	-9 (ix), #0x04
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:167: logical_y = Field.ly + 96;
	...
	jp	00127$
00114$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:168: } else if (messageId == SPR_MSG_TIMEUP) {
	ld	a, c
	sub	a, #0x40
	jr	NZ, 00111$
	ld	a, b
	dec	a
	jr	NZ, 00111$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:169: len = SPRITE_MSG_TIMEUP_LENGTH;
	ld	-9 (ix), #0x04
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:170: logical_y = Field.ly + 96;
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0060
	add	hl, de
	ex	de, hl
	jp	00127$
00111$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:171: } else if (messageId == SPR_MSG_HALFTIME) {
	ld	a, c
	sub	a, #0x44
	jr	NZ, 00108$
	ld	a, b
	dec	a
	jr	NZ, 00108$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:172: len = SPRITE_MSG_HALFTIME_LENGTH;
	ld	-9 (ix), #0x05
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:173: logical_y = Field.ly + 96;
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0060
	add	hl, de
	ex	de, hl
	jp	00127$
00108$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:174: } else if (messageId == SPR_MSG_PENALTIES) {
	ld	a, c
	sub	a, #0x49
	jr	NZ, 00105$
	ld	a, b
	dec	a
	jr	NZ, 00105$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:175: len = SPRITE_MSG_PENALTIES_LENGTH;
	ld	-9 (ix), #0x05
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:176: logical_y = Field.ly + 96;
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0060
	add	hl, de
	ex	de, hl
	jp	00127$
00105$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:177: } else if (messageId == SPR_MSG_OFFSIDE) {
	ld	a, c
	sub	a, #0xf8
	or	a, b
	jp	NZ,00136$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:178: len = SPRITE_MSG_OFFSIDE_LENGTH;
	ld	-9 (ix), #0x04
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:179: logical_y = Field.ly + 96;
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0060
	add	hl, de
	ex	de, hl
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:181: return;
	jp	00127$
00127$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:184: u8 start_x = 128 - (len * 8); // Centrato orizzontalmente: 128 - (lunghezza * 16 / 2)
	ld	a, -9 (ix)
	add	a, a
	add	a, a
	add	a, a
...
;	spillPairReg hl
	...
	sub	a, l
	ld	-8 (ix), a
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:186: for (u8 i = 0; i < len; i++) {
	ld	-1 (ix), #0x00
00131$:
	ld	a, -1 (ix)
	sub	a, -9 (ix)
	jp	NC, 00128$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:187: SwSprite[15 + i].lx = start_x + (i * 16);
	ld	a, -1 (ix)
	ld	-3 (ix), a
	ld	-2 (ix), #0x00
	ld	a, -3 (ix)
...
;	spillPairReg hl
	...
	ld	h, -6 (ix)
	ld	(hl), a
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:188: SwSprite[15 + i].ly = logical_y;
	ld	a, -7 (ix)
	add	a, #0x04
	ld	l, a
;	spillPairReg hl
...
;	spillPairReg hl
	...
	inc	hl
	ld	(hl), d
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:189: SwSprite[15 + i].frame = messageId + i;
	ld	a, -7 (ix)
	add	a, #0x0f
	ld	-5 (ix), a
	ld	a, -6 (ix)
...
;	spillPairReg hl
	...
	ld	a, -2 (ix)
	ld	(hl), a
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:190: SwSprite[15 + i].dx = 0;
	ld	a, -7 (ix)
	add	a, #0x11
	ld	l, a
;	spillPairReg hl
;	spillPairReg hl
	...
	ld	h, a
	ld	(hl), #0x00
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:191: SwSprite[15 + i].dy = 0;
	ld	a, -7 (ix)
	add	a, #0x12
	ld	l, a
;	spillPairReg hl
...
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:186: for (u8 i = 0; i < len; i++) {
	...
	jp	00131$
00128$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:195: for (u8 i = 15 + len; i < 24; i++) {
	ld	a, -9 (ix)
	add	a, #0x0f
	ld	c, a
00134$:
	...
	sub	a, #0x18
	jr	NC, 00136$
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:196: SwSprite[i].ly = 1000; // Nascondimento assoluto
	ld	b, #0x00
	ld	l, c
	ld	h, b
	add	hl, hl
...
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:195: for (u8 i = 15 + len; i < 24; i++) {
	...
	jp	00134$
00136$:
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:198: }
	ld	sp, ix
	pop	ix
	ret
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:201: void HideSpriteMessage()
;	---------------------------------
; Function HideSpriteMessage
; ---------------------------------
_HideSpriteMessage::
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:203: for (u8 i = 15; i < 24; i++) {
	ld	de, #_SwSprite+0
	ld	c, #0x0f
00103$:
	ld	a, c
	sub	a, #0x18
	ret	NC
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\projects\soccerlgMSX2/soccerlg_s5_b3.c:204: SwSprite[i].ly = 1000; // Nascondimento assoluto
	ld	b, #0x00
	ld	l, c
	ld	h, b
	add	hl, hl
