...
;./soccerlg.c:448: __endasm;
	...
	jp	(hl)
;./soccerlg.c:449: }
;./soccerlg.c:462: void VSyncCallback()
;	---------------------------------
; Function VSyncCallback
; ---------------------------------
_VSyncCallback::
;./soccerlg.c:464: g_VSynch = TRUE;
	ld	hl, #_g_VSynch
	ld	(hl), #0x01
;./soccerlg.c:466: Frms--;
	ld	iy, #_Frms
	dec	0 (iy)
;./soccerlg.c:467: if (Frms==0) {
	ld	a, (_Frms+0)
	or	a, a
	ret	NZ
;./soccerlg.c:468: Frms = 60;
	ld	0 (iy), #0x3c
;./soccerlg.c:469: if (TimerEnabled) {
	ld	a, (_TimerEnabled+0)
	or	a, a
	ret	Z
;./soccerlg.c:470: if (Mins > 0 || Secs > 0) {
	ld	a, (_Mins+0)
	or	a, a
	jr	NZ, 00104$
	ld	a, (_Secs+0)
	...
	ret	Z
00104$:
;./soccerlg.c:471: if (Secs==0) {
	ld	a, (_Secs+0)
	or	a, a
	jr	NZ, 00102$
;./soccerlg.c:472: Secs = 59;
	ld	hl, #_Secs
	ld	(hl), #0x3b
;./soccerlg.c:473: Mins--;
	ld	hl, #_Mins
...
_dummy:
	...
	.db #0x00	; 0
	.db #0x00	; 0
;./soccerlg.c:482: void WaitForVBlank(){
;	---------------------------------
; Function WaitForVBlank
; ---------------------------------
_WaitForVBlank::
;./soccerlg.c:483: while(!g_VSynch) {}
00101$:
	ld	a, (_g_VSynch+0)
	or	a, a
	jr	Z, 00101$
;./soccerlg.c:484: g_VSynch = FALSE;
	ld	hl, #_g_VSynch
	ld	(hl), #0x00
;./soccerlg.c:485: }
	ret
;./soccerlg.c:487: void LoadField(u8 vdp_page)
;	---------------------------------
; Function LoadField
; ---------------------------------
_LoadField::
	...
	ld	sp, hl
	ld	e, a
;./soccerlg.c:489: u32 base     = (u32)vdp_page * 0x8000;
	ld	d, #0x00
	ld	hl, #0x0000
	ld	h, l
;	spillPairReg hl
...
00168$:
	...
	ld	-4 (ix), l
	ld	-3 (ix), h
;./soccerlg.c:490: u8  u = GET_BANK_SEGMENT_HIGH(3);
	ld	hl, (#(_g_Bank0Segment + 6) + 0)
	ld	-2 (ix), h
;./soccerlg.c:491: u8  v = GET_BANK_SEGMENT_LOW(3);
	ld	-1 (ix), l
;./soccerlg.c:493: for (u8 i = 0; i < FIELD_SEG_COUNT; i++)
	ld	c, #0x00
00145$:
	ld	a, c
	sub	a, #0x04
	jr	NC, 00101$
;./soccerlg.c:495: u32 addr    = base + (u32)i * 8192;
	ld	e, c
	xor	a, a
	ld	l, a
;	spillPairReg hl
...
;	spillPairReg hl
	...
	pop	iy
	ex	de, hl
;./soccerlg.c:497: SET_BANK_SEGMENT_LOW (3, (FIELD_BIN_SEG + i) & 255);
	ld	a, c
	add	a, #0xfc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/system.h:101: inline void Poke(u16 addr, u8 val) { *(u8*)addr = val; }
	...
	ld	(#0xb000),a
;./soccerlg.c:498: SET_BANK_SEGMENT_HIGH(3, (FIELD_BIN_SEG + i) >>8);
	ld	a, c
	ld	h, #0x00
;	spillPairReg hl
;	spillPairReg hl
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/system.h:101: inline void Poke(u16 addr, u8 val) { *(u8*)addr = val; }
	ld	(#0x7ffe),a
;./soccerlg.c:499: VDP_WriteVRAM_128K((u8*)BANK3_BASE, (addr & 0xFFFF), (addr >> 16), 8192);
	ld	a, e
	push	iy
	pop	de
	push	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/system.h:101: inline void Poke(u16 addr, u8 val) { *(u8*)addr = val; }
	...
	ld	a, -1 (ix)
	ld	(hl), a
;./soccerlg.c:503: SET_BANK_SEGMENT_LOW (3, v);
;./soccerlg.c:504: }
	ld	sp, ix
	pop	ix
	ret
;./soccerlg.c:511: void main()
;	---------------------------------
; Function main
; ---------------------------------
_main::
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/system.h:193: inline u8 Sys_GetMSXVersion() { return g_MSXVER; } 
	ld	a, (_g_MSXVER+0)
;./soccerlg.c:514: if (Sys_GetMSXVersion() == MSXVER_1)
	or	a, a
	jr	NZ, 00102$
;./soccerlg.c:516: Bios_ClearScreen();
	call	_Bios_ClearScreen
;./soccerlg.c:517: Bios_TextPrintSting("This game need MSX2 or above");
	ld	bc, #___str_0+0
...
;./soccerlg.c:526: VDP_SetPalette(g_Palette);
	ld	hl, #_g_Palette
...
;	spillPairReg hl
	ld	a, #0x08
	call	_VDP_RegWriteBakMask
;./soccerlg.c:530: VDP_ClearVRAM();
	call	_VDP_ClearVRAM
;./soccerlg.c:531: VDP_FillVRAM(0x77, 0x0000, 0, 0x8000);
	ld	hl, #0x8000
	push	hl
	xor	a, a
	push	af
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/system.h:101: inline void Poke(u16 addr, u8 val) { *(u8*)addr = val; }
	ld	(#0xb000),a
;./soccerlg.c:542: Print_SetBitmapFont(g_Fonts);
	ld	hl, #_g_Fonts
	call	_Print_SetBitmapFont
;./soccerlg.c:543: Print_SetColor(4, 7);
	ld	l, #0x07
;	spillPairReg hl
;	spillPairReg hl
	ld	a, #0x04
...
;./soccerlg.c:545: Print_SetPosition(0,  8+768);Print_DrawText("A");
	push	bc
	ld	hl, #___str_1
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0310
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:546: Print_SetPosition(0,  16+768);Print_DrawText("U");
	push	bc
	ld	hl, #___str_2
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0318
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:547: Print_SetPosition(0,  24+768);Print_DrawText("S");
	push	bc
	ld	hl, #___str_3
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0320
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:548: Print_SetPosition(0,  32+768);Print_DrawText(" ");
	push	bc
	ld	hl, #___str_4
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0328
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:549: Print_SetPosition(0,  40+768);Print_DrawText("0");
	push	bc
	ld	hl, #___str_5
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0338
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:551: Print_SetPosition(0,  56+768);Print_DrawText("I");
	push	bc
	ld	hl, #___str_6
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0340
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:552: Print_SetPosition(0,  64+768);Print_DrawText("T");
	push	bc
	ld	hl, #___str_7
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0348
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:553: Print_SetPosition(0,  72+768);Print_DrawText("A");
	push	bc
	ld	hl, #___str_1
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0350
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:554: Print_SetPosition(0,  80+768);Print_DrawText(" ");
	push	bc
	ld	hl, #___str_4
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0358
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:555: Print_SetPosition(0,  88+768);Print_DrawText("0");
	push	bc
	ld	hl, #___str_5
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0308
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:558: Print_SetPosition(248,  8+768);Print_DrawText("T");
	push	bc
	ld	hl, #___str_7
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0310
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:559: Print_SetPosition(248,  16+768);Print_DrawText("I");
	push	bc
	ld	hl, #___str_6
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0318
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:560: Print_SetPosition(248,  24+768);Print_DrawText("M");
	push	bc
	ld	hl, #___str_8
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0320
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:561: Print_SetPosition(248,  32+768);Print_DrawText("E");
	push	bc
	ld	hl, #___str_9
	call	_Print_DrawText
	pop	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0330
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:563: Print_SetPosition(248,  48+768);Print_DrawFormat("%i",Mins);//Print_DrawText("3");	
	ld	a, (_Mins+0)
	ld	e, a
	ld	d, #0x00
	push	bc
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x033c
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:564: Print_SetPosition(248,  60+768);Print_DrawFormat("%i",Secs/10);	
	ld	a, (_Secs+0)
	ld	l, a
;	spillPairReg hl
;	spillPairReg hl
...
;E:/Dropbox/FAUSTO/SVILUPPI/MSX/CODE/C/MSXgl/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #0x0344
	ld	((_g_PrintData + 6)), hl
;./soccerlg.c:565: Print_SetPosition(248,  68+768);Print_DrawFormat("%i",Secs-Secs/10*10);	
	ld	a, (_Secs+0)
	ld	c, a
	ld	b, #0x00
	push	bc
...
;	spillPairReg hl
	...
	pop	af
	pop	af
;./soccerlg.c:574: Field.dy = 1;
	ld	hl, #(_Field + 18)
	ld	(hl), #0x01
;./soccerlg.c:575: Field.ly = 0;
	ld	hl, #0x0000
	ld	((_Field + 4)), hl
;./soccerlg.c:577: ScoreBoardLeft.lx = 0;
	ld	hl, #_ScoreBoardLeft
	ld	(hl), #0x00
;./soccerlg.c:578: ScoreBoardLeft.ly = Field.ly;
	ld	bc, (#(_Field + 4) + 0)
	ld	((_ScoreBoardLeft + 4)), bc
;./soccerlg.c:580: ScoreBoardRight.lx = 248;
	ld	hl, #_ScoreBoardRight
	ld	(hl), #0xf8
;./soccerlg.c:581: ScoreBoardRight.ly = Field.ly;
	ld	bc, (#(_Field + 4) + 0)
...
;	spillPairReg hl
	ld	a, #0x01
	call	_VDP_RegWriteBakMask
;./soccerlg.c:584: CallFnc_VOID_16_P2(SEG_DRAW, PlotField, Field.ly,   0);
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0000
	push	de
	push	hl
...
;./soccerlg.c:585: CallFnc_VOID_16_P2(SEG_DRAW, PlotField, Field.ly, 256);
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0100
	push	de
	push	hl
	...
	ld	a, #0x05
	call	_CallFnc_VOID_16_P2
;./soccerlg.c:586: CallFnc_VOID_16_P2(SEG_DRAW, PlotField, Field.ly, 512);
	ld	hl, (#(_Field + 4) + 0)
	ld	de, #0x0200
	push	de
	push	hl
	...
	ld	a, #0x05
	call	_CallFnc_VOID_16_P2
;./soccerlg.c:596: Bios_SetHookCallback(H_TIMI, VSyncCallback);
	ld	de, #_VSyncCallback
	ld	hl, #0xfd9f
	call	_Bios_SetHookCallback
;./soccerlg.c:598: ScoreBoardLeft.x0 = ScoreBoardLeft.lx;
	ld	bc, #_ScoreBoardLeft + 1
	ld	a, (#_ScoreBoardLeft + 0)
	ld	(bc), a
;./soccerlg.c:599: ScoreBoardLeft.x1 = ScoreBoardLeft.lx;
	ld	bc, #_ScoreBoardLeft + 2
	ld	a, (#_ScoreBoardLeft + 0)
	ld	(bc), a
;./soccerlg.c:600: ScoreBoardLeft.x2 = ScoreBoardLeft.lx;
	ld	bc, #_ScoreBoardLeft + 3
	ld	a, (#_ScoreBoardLeft + 0)
	ld	(bc), a
;./soccerlg.c:602: ScoreBoardRight.x0 = ScoreBoardRight.lx;
	ld	bc, #_ScoreBoardRight + 1
	ld	a, (#_ScoreBoardRight + 0)
	ld	(bc), a
;./soccerlg.c:603: ScoreBoardRight.x1 = ScoreBoardRight.lx;
	ld	bc, #_ScoreBoardRight + 2
	ld	a, (#_ScoreBoardRight + 0)
	ld	(bc), a
;./soccerlg.c:604: ScoreBoardRight.x2 = ScoreBoardRight.lx;
...
;	spillPairReg hl
	ld	a, #0x01
	call	_VDP_RegWriteBakMask
;./soccerlg.c:609: CallFnc_VOID(4,MainLoop);
	ld	de, #_MainLoop
	ld	a, #0x04
;./soccerlg.c:611: }
	jp	_CallFnc_VOID
