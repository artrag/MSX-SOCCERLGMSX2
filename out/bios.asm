...
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/bios.c:429: __endasm;
	...
	ld	a, 0(iy)
	call	0x0056
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/bios.c:430: }
	pop	hl
	inc	sp
	jp	(hl)
...
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/bios.c:454: __endasm;
	...
	ld	b, 1(iy)
	call	0x0059
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/bios.c:455: }
	pop	hl
	pop	af
	jp	(hl)
...
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/bios.c:479: __endasm;
	...
	ld	b, 1(iy)
	call	0x005C
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/bios.c:480: }
	pop	hl
	pop	af
	jp	(hl)
