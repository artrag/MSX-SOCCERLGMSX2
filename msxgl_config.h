...
#define V9_USE_MODE_B5				FALSE	// Bitmap mode 5 640x400 (VGA)
#define V9_USE_MODE_B6				FALSE	// Bitmap mode 6 640x480 (VGA)
#define V9_USE_MODE_B7				FALSE	// Bitmap mode 7 1024x212 (Undocumented v9990 mode)
...
#define MEM_USE_FASTSET				TRUE	// Add support for fast-set function (using unrolled-LDI loop)
...
#define DOS_USE_FCB					FALSE	// Add support for file managment features through FCB structure
#define DOS_USE_HANDLE				FALSE	// Add support for file managment features through file handle
#define DOS_USE_UTILITIES			FALSE	// Add support for file managment features through filename
#define DOS_USE_VALIDATOR			FALSE	// Add support for last error backup and return value validation
...
//#define GAMEPAWN_USE_VRAM_COL		FALSE	// Use VRAM to check tile collision (otherwise, use RAM buffer)
#define GAMEPAWN_TILEMAP_WIDTH		32		// Width of the tiles map
#define GAMEPAWN_TILEMAP_HEIGHT		27		// Height of the tiles map
#define GAMEPAWN_USE_V9990			TRUE	// Use V9990 sprites
...
#define GAMEPAWN_SPT_MODE  			GAMEPAWN_SPT_MODE_V9_P1 
//-----------------------------------------------------------------------------
// GAME MENU MODULE
//-----------------------------------------------------------------------------
